...
perfectly and devastatingly in agreement (within uncertainty, of course) with predictions made by the Standard Model (edit: recent results [here](https://cerncourier.com/a/fermilab-strengthens-muon-g-2-anomaly/){:target="_blank"} and [here](https://home.cern/news/news/physics/intriguing-new-result-lhcb-experiment-cern){:target="_blank"} display hints of new physics but should, for now, be treated with caution). We have discovered 
