...
experiment, we can cross it off the (very long and ever increasing) list. (Edit 28/04/2021: see our recent paper, in which we studied a heavy dark matter candidate coupling only to the top sector, [here](https://arxiv.org/abs/2104.12795).)
